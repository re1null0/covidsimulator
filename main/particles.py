...
#        np.random.seed(simulator.SEED+2*simulator.number_of_iter)
    ...
    def get_contact(self, i, simulator):
        ...
        With accordance whether the app was installed, particles and the time state are saved in the contact_cell.
        ...
        Returns
        -------
        contacts (list): list of contact calculated by KDTree
